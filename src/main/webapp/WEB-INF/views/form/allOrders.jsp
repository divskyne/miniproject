...
<h2>All Orders</h2>
<section>
<a href="/order/newOrder" class="btn btn-default">Add new Order</a>
...
<tr>
	...
	<td><a href="/order/newOrder?orderId=${order.getId()}">Edit</a></td>
	<td><a href="/order/deleteorder?date=${order.getDate()}">Delete</a></td>
</tr>
</c:forEach>
</table>
</section>
